  ...
  return (
    <div className="flex h-screen bg-black overflow-hidden font-sans">
      ...
      <div className="flex-1 flex flex-col min-w-0 bg-black">
        <div className="flex-1 p-6 flex items-center justify-center bg-[#0a0a0a]/50">
          <HLSPlayer 
            src={session.hlsUrl} 
      ...
      {/* Side Chat */}
      <aside className="w-96 flex flex-col border-l border-white/5 overflow-hidden animate-slide-in-right">
